...
{
    [Route("api/NaturalezaVariable")]
    [ApiController]
    [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
    public class NaturalezaVariableController : ControllerBase
    {
        private readonly INaturalezaVariableRepository<NaturalezaVariableModel> _IRepository;

        //Constructor
        public NaturalezaVariableController(INaturalezaVariableRepository<NaturalezaVariableModel> IRepository)
        {
            this._IRepository = IRepository;
        }

        // GET: api/NaturalezaVariable
        /// <summary>
        ...
        public async Task<IActionResult> Get()
        {
            ...
            //IEnumerable<NaturalezaVariableModel> Data = await _IRepository.GetAll();

            //Retornamos datos.
            return Ok(Data);
        }

        // GET: api/NaturalezaVariable/5
        /// <summary>
        ...
        /// <returns>Configruacion ADO</returns>
        [HttpPost]
        public async Task<IActionResult> Post([FromBody] NaturalezaVariableModel entity)
        {
        ...
        /// <returns>Configruacion ADO</returns>
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Put(int id, [FromBody] NaturalezaVariableModel entity)
        {
            //Validamos si recibimos una entidad.
            if (entity == null)
            {
            ...
            NaturalezaVariableModel ToUpdate = await _IRepository.Get(id);
            if (ToUpdate == null)
            {
                return NotFound("The record couldn't be found.");
            }
        ...
        // DELETE: api/NaturalezaVariable/5
        /// <summary>
